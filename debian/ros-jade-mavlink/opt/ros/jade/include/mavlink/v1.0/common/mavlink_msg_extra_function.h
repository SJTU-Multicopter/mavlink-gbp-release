						       ...
						       uint8_t obs_avoid_enable, uint8_t laser_height_enable, uint8_t add_one, uint8_t add_two, uint8_t add_three)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN, MAVLINK_MSG_ID_EXTRA_FUNCTION_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN);
#endif
}
						           ...
						           uint8_t obs_avoid_enable,uint8_t laser_height_enable,uint8_t add_one,uint8_t add_two,uint8_t add_three)
{
	...
	msg->msgid = MAVLINK_MSG_ID_EXTRA_FUNCTION;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN, MAVLINK_MSG_ID_EXTRA_FUNCTION_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTRA_FUNCTION, buf, MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN, MAVLINK_MSG_ID_EXTRA_FUNCTION_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTRA_FUNCTION, buf, MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN);
#endif
#else
	mavlink_extra_function_t packet;
	packet.obs_avoid_enable = obs_avoid_enable;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTRA_FUNCTION, (const char *)&packet, MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN, MAVLINK_MSG_ID_EXTRA_FUNCTION_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTRA_FUNCTION, (const char *)&packet, MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN);
#endif
#endif
}
...
#else
	memcpy(extra_function, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_EXTRA_FUNCTION_LEN);
#endif
}
