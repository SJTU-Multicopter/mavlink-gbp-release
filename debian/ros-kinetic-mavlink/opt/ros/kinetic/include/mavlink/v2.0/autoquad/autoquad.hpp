...
enum class AUTOQUAD_MAVLINK_DEFS_VERSION
{
    AQ_MAVLINK_DEFS_VERSION_1=1, /*  | */
};

//! AUTOQUAD_MAVLINK_DEFS_VERSION ENUM_END
constexpr auto AUTOQUAD_MAVLINK_DEFS_VERSION_ENUM_END = 2;
...
enum class AUTOQUAD_NAV_STATUS : int64_t
{
...
//! AUTOQUAD_NAV_STATUS ENUM_END
constexpr auto AUTOQUAD_NAV_STATUS_ENUM_END = 2147483649;

/** @brief Commands to be executed by the MAV. They can be executed on user request, or as part of a mission script. If the action is used in a mission, the parameter mapping to the waypoint/mission message is as follows: Param 1, Param 2, Param 3, Param 4, X: Param 5, Y:Param 6, Z:Param 7. This command list is similar what ARINC 424 is for commercial aircraft: A data format how to interpret waypoint/mission data. */
enum class MAV_CMD
{
    AQ_NAV_LEG_ORBIT=1, /* Orbit a waypoint. |Orbit radius in meters| Loiter time in decimal seconds| Maximum horizontal speed in m/s| Desired yaw angle at waypoint| Latitude| Longitude| Altitude|  */
    AQ_TELEMETRY=2, /* Start/stop AutoQuad telemetry values stream. |Start or stop (1 or 0)| Stream frequency in us| Dataset ID (refer to aq_mavlink.h::mavlinkCustomDataSets enum in AQ flight controller code)| Empty| Empty| Empty| Empty|  */
    AQ_REQUEST_VERSION=4, /* Request AutoQuad firmware version number. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
...
enum class MAV_DATA_STREAM
{
    ...
    PROPULSION=13, /* Motor/ESC telemetry data. | */
};

//! MAV_DATA_STREAM ENUM_END
constexpr auto MAV_DATA_STREAM_ENUM_END = 14;
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_aq_telemetry_f.hpp"
#include "./mavlink_msg_aq_esc_telemetry.hpp"
