...
constexpr auto MAV_AUTOPILOT_ENUM_END = 18;
...
constexpr auto MAV_SYS_STATUS_SENSOR_ENUM_END = 16777217;
...
constexpr auto MAV_PROTOCOL_CAPABILITY_ENUM_END = 8193;
...
constexpr auto MAV_LANDED_STATE_ENUM_END = 3;
...
enum class MAV_COLLISION_ACTION : uint8_t
{
    ...
    ASCEND_OR_DESCEND=2, /* Ascend or Descend to avoid thread | */
    MOVE_HORIZONTALLY=3, /* Ascend or Descend to avoid thread | */
...
#include "./mavlink_msg_sonar_distance.hpp"
#include "./mavlink_msg_laser_distance.hpp"
#include "./mavlink_msg_offboard_setpoint.hpp"
#include "./mavlink_msg_offboard_setpoint_confirm.hpp"
...
#include "./mavlink_msg_pump_controller.hpp"
#include "./mavlink_msg_pump_status.hpp"
#include "./mavlink_msg_extra_function.hpp"
