...
enum class MAV_PREFLIGHT_STORAGE_ACTION
{
    PFS_CMD_READ_ALL=0, /* Read all parameters from storage | */
    PFS_CMD_WRITE_ALL=1, /* Write all parameters to storage | */
    PFS_CMD_CLEAR_ALL=2, /* Clear all  parameters in storage | */
    PFS_CMD_READ_SPECIFIC=3, /* Read specific parameters from storage | */
    PFS_CMD_WRITE_SPECIFIC=4, /* Write specific parameters to storage | */
    PFS_CMD_CLEAR_SPECIFIC=5, /* Clear specific parameters in storage | */
    PFS_CMD_DO_NOTHING=6, /* do nothing | */
};

//! MAV_PREFLIGHT_STORAGE_ACTION ENUM_END
constexpr auto MAV_PREFLIGHT_STORAGE_ACTION_ENUM_END = 7;

/** @brief Commands to be executed by the MAV. They can be executed on user request, or as part of a mission script. If the action is used in a mission, the parameter mapping to the waypoint/mission message is as follows: Param 1, Param 2, Param 3, Param 4, X: Param 5, Y:Param 6, Z:Param 7. This command list is similar what ARINC 424 is for commercial aircraft: A data format how to interpret waypoint/mission data. */
enum class MAV_CMD
{
    PREFLIGHT_STORAGE_ADVANCED=0, /* Request storage of different parameter values and logs. This command will be only accepted if in pre-flight mode. |Storage action: Action defined by MAV_PREFLIGHT_STORAGE_ACTION_ADVANCED| Storage area as defined by parameter database| Storage flags as defined by parameter database| Empty| Empty| Empty| Empty|  */
    ...
    DO_SET_POSITION_YAW_THRUST=213, /* Sets a desired vehicle turn angle and thrust change |yaw angle to adjust steering by in centidegress| Thrust - normalized to -2 .. 2| Empty| Empty| Empty| Empty| Empty|  */
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_flexifunction_set.hpp"
#include "./mavlink_msg_flexifunction_read_req.hpp"
#include "./mavlink_msg_flexifunction_buffer_function.hpp"
#include "./mavlink_msg_flexifunction_buffer_function_ack.hpp"
#include "./mavlink_msg_flexifunction_directory.hpp"
#include "./mavlink_msg_flexifunction_directory_ack.hpp"
#include "./mavlink_msg_flexifunction_command.hpp"
#include "./mavlink_msg_flexifunction_command_ack.hpp"
#include "./mavlink_msg_serial_udb_extra_f2_a.hpp"
#include "./mavlink_msg_serial_udb_extra_f2_b.hpp"
#include "./mavlink_msg_serial_udb_extra_f4.hpp"
#include "./mavlink_msg_serial_udb_extra_f5.hpp"
#include "./mavlink_msg_serial_udb_extra_f6.hpp"
#include "./mavlink_msg_serial_udb_extra_f7.hpp"
#include "./mavlink_msg_serial_udb_extra_f8.hpp"
#include "./mavlink_msg_serial_udb_extra_f13.hpp"
#include "./mavlink_msg_serial_udb_extra_f14.hpp"
#include "./mavlink_msg_serial_udb_extra_f15.hpp"
#include "./mavlink_msg_serial_udb_extra_f16.hpp"
#include "./mavlink_msg_altitudes.hpp"
#include "./mavlink_msg_airspeeds.hpp"
