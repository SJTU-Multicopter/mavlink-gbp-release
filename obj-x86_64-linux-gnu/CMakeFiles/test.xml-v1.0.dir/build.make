...
CMakeFiles/test.xml-v1.0: include/v1.0/test/test.h

include/v1.0/test/test.h: ../message_definitions/v1.0/test.xml
include/v1.0/test/test.h: ../message_definitions/v1.0/common.xml
include/v1.0/test/test.h: ../pymavlink/tools/mavgen.py
	$(CMAKE_COMMAND) -E cmake_progress_report /home/cc/mavlink-gbp-release/obj-x86_64-linux-gnu/CMakeFiles $(CMAKE_PROGRESS_1)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "Generating include/v1.0/test/test.h"
	/usr/bin/env PYTHONPATH="/home/cc/mavlink-gbp-release:/opt/ros/jade/lib/python2.7/dist-packages" /usr/bin/python2 /home/cc/mavlink-gbp-release/pymavlink/tools/mavgen.py --lang=C --wire-protocol=1.0 --output=include/v1.0 /home/cc/mavlink-gbp-release/message_definitions/v1.0/test.xml

test.xml-v1.0: CMakeFiles/test.xml-v1.0
test.xml-v1.0: include/v1.0/test/test.h
