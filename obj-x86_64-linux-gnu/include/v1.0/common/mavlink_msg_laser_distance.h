...
#define MAVLINK_MSG_ID_LASER_DISTANCE_MIN_LEN 16
 ...
 * @param angle angle
 * @param laser_x laser x
 * @param laser_y laser y
						       ...
						       float min_distance, float angle, float laser_x, float laser_y)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_LASER_DISTANCE_MIN_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_CRC);
}
						           ...
						           float min_distance,float angle,float laser_x,float laser_y)
{
	...
	msg->msgid = MAVLINK_MSG_ID_LASER_DISTANCE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_LASER_DISTANCE_MIN_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_CRC);
}
...
static inline void mavlink_msg_laser_distance_send(mavlink_channel_t chan, float min_distance, float angle, float laser_x, float laser_y)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LASER_DISTANCE, buf, MAVLINK_MSG_ID_LASER_DISTANCE_MIN_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_CRC);
#else
	mavlink_laser_distance_t packet;
	packet.min_distance = min_distance;
	packet.angle = angle;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LASER_DISTANCE, (const char *)&packet, MAVLINK_MSG_ID_LASER_DISTANCE_MIN_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_laser_distance_send_struct(mavlink_channel_t chan, const mavlink_laser_distance_t* laser_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_laser_distance_send(chan, laser_distance->min_distance, laser_distance->angle, laser_distance->laser_x, laser_distance->laser_y);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LASER_DISTANCE, (const char *)laser_distance, MAVLINK_MSG_ID_LASER_DISTANCE_MIN_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_LEN, MAVLINK_MSG_ID_LASER_DISTANCE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_LASER_DISTANCE_LEN? msg->len : MAVLINK_MSG_ID_LASER_DISTANCE_LEN;
        memset(laser_distance, 0, MAVLINK_MSG_ID_LASER_DISTANCE_LEN);
	memcpy(laser_distance, _MAV_PAYLOAD(msg), len);
#endif
}
