...
static void mavlink_test_sonar_distance(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SONAR_DISTANCE >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_sonar_distance_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
	mavlink_sonar_distance_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.sonar_front = packet_in.sonar_front;
        packet1.sonar_behind = packet_in.sonar_behind;
        packet1.sonar_left = packet_in.sonar_left;
        packet1.sonar_right = packet_in.sonar_right;
        packet1.sonar_up = packet_in.sonar_up;
        packet1.sonar_down = packet_in.sonar_down;
        packet1.sonar_cam = packet_in.sonar_cam;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SONAR_DISTANCE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SONAR_DISTANCE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sonar_distance_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_sonar_distance_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sonar_distance_pack(system_id, component_id, &msg , packet1.sonar_front , packet1.sonar_behind , packet1.sonar_left , packet1.sonar_right , packet1.sonar_up , packet1.sonar_down , packet1.sonar_cam );
	mavlink_msg_sonar_distance_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sonar_distance_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sonar_front , packet1.sonar_behind , packet1.sonar_left , packet1.sonar_right , packet1.sonar_up , packet1.sonar_down , packet1.sonar_cam );
	mavlink_msg_sonar_distance_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_sonar_distance_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sonar_distance_send(MAVLINK_COMM_1 , packet1.sonar_front , packet1.sonar_behind , packet1.sonar_left , packet1.sonar_right , packet1.sonar_up , packet1.sonar_down , packet1.sonar_cam );
	mavlink_msg_sonar_distance_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_laser_distance(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_LASER_DISTANCE >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_laser_distance_t packet_in = {
		17.0,45.0,73.0,101.0
    };
	mavlink_laser_distance_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.min_distance = packet_in.min_distance;
        packet1.angle = packet_in.angle;
        packet1.laser_x = packet_in.laser_x;
        packet1.laser_y = packet_in.laser_y;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_LASER_DISTANCE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_LASER_DISTANCE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_laser_distance_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_laser_distance_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_laser_distance_pack(system_id, component_id, &msg , packet1.min_distance , packet1.angle , packet1.laser_x , packet1.laser_y );
	mavlink_msg_laser_distance_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_laser_distance_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.min_distance , packet1.angle , packet1.laser_x , packet1.laser_y );
	mavlink_msg_laser_distance_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_laser_distance_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_laser_distance_send(MAVLINK_COMM_1 , packet1.min_distance , packet1.angle , packet1.laser_x , packet1.laser_y );
	mavlink_msg_laser_distance_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_offboard_setpoint(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OFFBOARD_SETPOINT >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_offboard_setpoint_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_OFFBOARD_SETPOINT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OFFBOARD_SETPOINT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_offboard_setpoint_confirm(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OFFBOARD_SETPOINT_CONFIRM >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_offboard_setpoint_confirm_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_OFFBOARD_SETPOINT_CONFIRM_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OFFBOARD_SETPOINT_CONFIRM_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_pump_controller(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PUMP_CONTROLLER >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_pump_controller_t packet_in = {
		17.0,45.0
    };
	mavlink_pump_controller_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.pump_speed_sp = packet_in.pump_speed_sp;
        packet1.spray_speed_sp = packet_in.spray_speed_sp;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PUMP_CONTROLLER_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PUMP_CONTROLLER_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_controller_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_pump_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_controller_pack(system_id, component_id, &msg , packet1.pump_speed_sp , packet1.spray_speed_sp );
	mavlink_msg_pump_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_controller_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pump_speed_sp , packet1.spray_speed_sp );
	mavlink_msg_pump_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_pump_controller_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_controller_send(MAVLINK_COMM_1 , packet1.pump_speed_sp , packet1.spray_speed_sp );
	mavlink_msg_pump_controller_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_pump_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PUMP_STATUS >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_pump_status_t packet_in = {
		17.0,45.0
    };
	mavlink_pump_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.pump_speed = packet_in.pump_speed;
        packet1.spray_speed = packet_in.spray_speed;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PUMP_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PUMP_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_status_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_pump_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_status_pack(system_id, component_id, &msg , packet1.pump_speed , packet1.spray_speed );
	mavlink_msg_pump_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pump_speed , packet1.spray_speed );
	mavlink_msg_pump_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_pump_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_status_send(MAVLINK_COMM_1 , packet1.pump_speed , packet1.spray_speed );
	mavlink_msg_pump_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_extra_function(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_EXTRA_FUNCTION >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_extra_function_t packet_in = {
		5,72,139,206,17
    };
	mavlink_extra_function_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.obs_avoid_enable = packet_in.obs_avoid_enable;
        packet1.laser_height_enable = packet_in.laser_height_enable;
        packet1.add_one = packet_in.add_one;
        packet1.add_two = packet_in.add_two;
        packet1.add_three = packet_in.add_three;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_EXTRA_FUNCTION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_EXTRA_FUNCTION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_extra_function_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_extra_function_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_extra_function_pack(system_id, component_id, &msg , packet1.obs_avoid_enable , packet1.laser_height_enable , packet1.add_one , packet1.add_two , packet1.add_three );
	mavlink_msg_extra_function_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_extra_function_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.obs_avoid_enable , packet1.laser_height_enable , packet1.add_one , packet1.add_two , packet1.add_three );
	mavlink_msg_extra_function_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_extra_function_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_extra_function_send(MAVLINK_COMM_1 , packet1.obs_avoid_enable , packet1.laser_height_enable , packet1.add_one , packet1.add_two , packet1.add_three );
	mavlink_msg_extra_function_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
