...
TEST(common, ATTITUDE_QUATERNION_COV)
{
    ...
    packet_in.pitchspeed = 185.0;
    packet_in.yawspeed = 213.0;
    packet_in.covariance = {{ 241.0, 242.0, 243.0, 244.0, 245.0, 246.0, 247.0, 248.0, 249.0 }};
...
TEST(common, GLOBAL_POSITION_INT_COV)
{
    ...
    packet_in.vy = 241.0;
    packet_in.vz = 269.0;
    packet_in.covariance = {{ 297.0, 298.0, 299.0, 300.0, 301.0, 302.0, 303.0, 304.0, 305.0, 306.0, 307.0, 308.0, 309.0, 310.0, 311.0, 312.0, 313.0, 314.0, 315.0, 316.0, 317.0, 318.0, 319.0, 320.0, 321.0, 322.0, 323.0, 324.0, 325.0, 326.0, 327.0, 328.0, 329.0, 330.0, 331.0, 332.0 }};
...
TEST(common, LOCAL_POSITION_NED_COV)
{
    ...
    packet_in.ay = 297.0;
    packet_in.az = 325.0;
    packet_in.covariance = {{ 353.0, 354.0, 355.0, 356.0, 357.0, 358.0, 359.0, 360.0, 361.0, 362.0, 363.0, 364.0, 365.0, 366.0, 367.0, 368.0, 369.0, 370.0, 371.0, 372.0, 373.0, 374.0, 375.0, 376.0, 377.0, 378.0, 379.0, 380.0, 381.0, 382.0, 383.0, 384.0, 385.0, 386.0, 387.0, 388.0, 389.0, 390.0, 391.0, 392.0, 393.0, 394.0, 395.0, 396.0, 397.0 }};
...
TEST(common, SONAR_DISTANCE)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::SONAR_DISTANCE packet_in{};
    packet_in.sonar_front = 17.0;
    packet_in.sonar_behind = 45.0;
    packet_in.sonar_left = 73.0;
    packet_in.sonar_right = 101.0;
    packet_in.sonar_up = 129.0;
    packet_in.sonar_down = 157.0;
    packet_in.sonar_cam = 185.0;

    mavlink::common::msg::SONAR_DISTANCE packet1{};
    mavlink::common::msg::SONAR_DISTANCE packet2{};
    ...
    EXPECT_EQ(packet1.sonar_front, packet2.sonar_front);
    EXPECT_EQ(packet1.sonar_behind, packet2.sonar_behind);
    EXPECT_EQ(packet1.sonar_left, packet2.sonar_left);
    EXPECT_EQ(packet1.sonar_right, packet2.sonar_right);
    EXPECT_EQ(packet1.sonar_up, packet2.sonar_up);
    EXPECT_EQ(packet1.sonar_down, packet2.sonar_down);
    EXPECT_EQ(packet1.sonar_cam, packet2.sonar_cam);
}

#ifdef TEST_INTEROP
TEST(common_interop, SONAR_DISTANCE)
{
    mavlink_message_t msg;
    ...
    mavlink_sonar_distance_t packet_c {
    ...
    mavlink_msg_sonar_distance_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.sonar_front, packet2.sonar_front);
    EXPECT_EQ(packet_in.sonar_behind, packet2.sonar_behind);
    EXPECT_EQ(packet_in.sonar_left, packet2.sonar_left);
    EXPECT_EQ(packet_in.sonar_right, packet2.sonar_right);
    EXPECT_EQ(packet_in.sonar_up, packet2.sonar_up);
    EXPECT_EQ(packet_in.sonar_down, packet2.sonar_down);
    EXPECT_EQ(packet_in.sonar_cam, packet2.sonar_cam);
...
TEST(common, LASER_DISTANCE)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::LASER_DISTANCE packet_in{};
    packet_in.min_distance = 17.0;
    packet_in.angle = 45.0;
    packet_in.laser_x = 73.0;
    packet_in.laser_y = 101.0;

    mavlink::common::msg::LASER_DISTANCE packet1{};
    mavlink::common::msg::LASER_DISTANCE packet2{};
    ...
    EXPECT_EQ(packet1.min_distance, packet2.min_distance);
    EXPECT_EQ(packet1.angle, packet2.angle);
    EXPECT_EQ(packet1.laser_x, packet2.laser_x);
    EXPECT_EQ(packet1.laser_y, packet2.laser_y);
}

#ifdef TEST_INTEROP
TEST(common_interop, LASER_DISTANCE)
{
    mavlink_message_t msg;
    ...
    mavlink_laser_distance_t packet_c {
    ...
    mavlink_msg_laser_distance_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.min_distance, packet2.min_distance);
    EXPECT_EQ(packet_in.angle, packet2.angle);
    EXPECT_EQ(packet_in.laser_x, packet2.laser_x);
    EXPECT_EQ(packet_in.laser_y, packet2.laser_y);
...
TEST(common, OFFBOARD_SETPOINT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::OFFBOARD_SETPOINT packet_in{};
    packet_in.seq = 89;
    packet_in.total = 156;
    packet_in.px_1 = 17.0;
    packet_in.py_1 = 45.0;
    packet_in.ph_1 = 73.0;
    packet_in.px_2 = 101.0;
    packet_in.py_2 = 129.0;
    packet_in.ph_2 = 157.0;
    packet_in.yaw = 185.0;

    mavlink::common::msg::OFFBOARD_SETPOINT packet1{};
    mavlink::common::msg::OFFBOARD_SETPOINT packet2{};
    ...
    EXPECT_EQ(packet1.px_1, packet2.px_1);
    EXPECT_EQ(packet1.py_1, packet2.py_1);
    EXPECT_EQ(packet1.ph_1, packet2.ph_1);
    EXPECT_EQ(packet1.px_2, packet2.px_2);
    EXPECT_EQ(packet1.py_2, packet2.py_2);
    EXPECT_EQ(packet1.ph_2, packet2.ph_2);
    EXPECT_EQ(packet1.yaw, packet2.yaw);
}

#ifdef TEST_INTEROP
TEST(common_interop, OFFBOARD_SETPOINT)
{
    mavlink_message_t msg;
    ...
    mavlink_offboard_setpoint_t packet_c {
    ...
    mavlink_msg_offboard_setpoint_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.px_1, packet2.px_1);
    EXPECT_EQ(packet_in.py_1, packet2.py_1);
    EXPECT_EQ(packet_in.ph_1, packet2.ph_1);
    EXPECT_EQ(packet_in.px_2, packet2.px_2);
    EXPECT_EQ(packet_in.py_2, packet2.py_2);
    EXPECT_EQ(packet_in.ph_2, packet2.ph_2);
    EXPECT_EQ(packet_in.yaw, packet2.yaw);
...
TEST(common, OFFBOARD_SETPOINT_CONFIRM)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::OFFBOARD_SETPOINT_CONFIRM packet_in{};
    packet_in.seq = 77;
    packet_in.total = 144;
    packet_in.px_1 = 17.0;
    packet_in.py_1 = 45.0;
    ...
    mavlink::common::msg::OFFBOARD_SETPOINT_CONFIRM packet1{};
    mavlink::common::msg::OFFBOARD_SETPOINT_CONFIRM packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, OFFBOARD_SETPOINT_CONFIRM)
{
    mavlink_message_t msg;
    ...
    mavlink_offboard_setpoint_confirm_t packet_c {
    ...
    mavlink_msg_offboard_setpoint_confirm_encode(1, 1, &msg, &packet_c);
...
TEST(common, PUMP_CONTROLLER)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::PUMP_CONTROLLER packet_in{};
    packet_in.pump_speed_sp = 17.0;
    packet_in.spray_speed_sp = 45.0;

    mavlink::common::msg::PUMP_CONTROLLER packet1{};
    mavlink::common::msg::PUMP_CONTROLLER packet2{};
    ...
    EXPECT_EQ(packet1.pump_speed_sp, packet2.pump_speed_sp);
    EXPECT_EQ(packet1.spray_speed_sp, packet2.spray_speed_sp);
}

#ifdef TEST_INTEROP
TEST(common_interop, PUMP_CONTROLLER)
{
    mavlink_message_t msg;
    ...
    mavlink_pump_controller_t packet_c {
         17.0, 45.0
    };
    ...
    mavlink_msg_pump_controller_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.pump_speed_sp, packet2.pump_speed_sp);
    EXPECT_EQ(packet_in.spray_speed_sp, packet2.spray_speed_sp);
...
TEST(common, PUMP_STATUS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::PUMP_STATUS packet_in{};
    packet_in.pump_speed = 17.0;
    packet_in.spray_speed = 45.0;

    mavlink::common::msg::PUMP_STATUS packet1{};
    mavlink::common::msg::PUMP_STATUS packet2{};
    ...
    EXPECT_EQ(packet1.pump_speed, packet2.pump_speed);
    EXPECT_EQ(packet1.spray_speed, packet2.spray_speed);
}

#ifdef TEST_INTEROP
TEST(common_interop, PUMP_STATUS)
{
    mavlink_message_t msg;
    ...
    mavlink_pump_status_t packet_c {
         17.0, 45.0
    };
    ...
    mavlink_msg_pump_status_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.pump_speed, packet2.pump_speed);
    EXPECT_EQ(packet_in.spray_speed, packet2.spray_speed);
...
TEST(common, EXTRA_FUNCTION)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::EXTRA_FUNCTION packet_in{};
    packet_in.obs_avoid_enable = 5;
    packet_in.laser_height_enable = 72;
    packet_in.add_one = 139;
    packet_in.add_two = 206;
    packet_in.add_three = 17;

    mavlink::common::msg::EXTRA_FUNCTION packet1{};
    mavlink::common::msg::EXTRA_FUNCTION packet2{};
    ...
    EXPECT_EQ(packet1.obs_avoid_enable, packet2.obs_avoid_enable);
    EXPECT_EQ(packet1.laser_height_enable, packet2.laser_height_enable);
    EXPECT_EQ(packet1.add_one, packet2.add_one);
    EXPECT_EQ(packet1.add_two, packet2.add_two);
    EXPECT_EQ(packet1.add_three, packet2.add_three);
}

#ifdef TEST_INTEROP
TEST(common_interop, EXTRA_FUNCTION)
{
    mavlink_message_t msg;
    ...
    mavlink_extra_function_t packet_c {
         5, 72, 139, 206, 17
    };
    ...
    mavlink_msg_extra_function_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.obs_avoid_enable, packet2.obs_avoid_enable);
    EXPECT_EQ(packet_in.laser_height_enable, packet2.laser_height_enable);
    EXPECT_EQ(packet_in.add_one, packet2.add_one);
    EXPECT_EQ(packet_in.add_two, packet2.add_two);
    EXPECT_EQ(packet_in.add_three, packet2.add_three);
